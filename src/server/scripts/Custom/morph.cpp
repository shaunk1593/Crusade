/*
morpher_npc
Developer: Project2k14, now: -Ant i-  || Ac-web.org
Status: 100%
Comment: This NPC is used for Wrath of the Lich King, morphs into racial morphs (Changes the race but not the gear you wear)
Tested: Cataclysm: Yes [X] No [ ] WOTLK: Yes [X] No [ ]
