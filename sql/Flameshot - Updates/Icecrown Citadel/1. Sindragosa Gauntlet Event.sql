...
UPDATE `creature_template` SET `minlevel` = 80, `maxlevel` = 80, `exp` = 2, `faction` = 21, `mechanic_immune_mask` = 8388624 WHERE `entry` IN (37228, 37229, 37232, 37501, 37502, 38197, 38198, 38362, 38134, 38137);
UPDATE `creature_template` SET `DamageModifier` = 7.5 WHERE `entry` IN (37228, 37229);
UPDATE `creature_template` SET `DamageModifier` = 13 /*`lootid` = 100002*/ WHERE `entry` IN (38134, 38137);
UPDATE `creature_template` SET `DamageModifier` = 2 WHERE `entry` = 38362;
